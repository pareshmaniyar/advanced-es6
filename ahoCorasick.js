...
var ac = new AhoCorasick(['ab', 'ac', 'abc', 'abe', 'abcd', 'bcd', 'cde', 'cd']);
var results = ac.search('abababcdeccd');
console.log(results);
// var a2c = new AhoCorasick(['keyword1', 'keyword2', 'etc']);
// var results2 = a2c.search('should find keyword1 at position 19 and keyword2 at position 47.');
